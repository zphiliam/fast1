...
- 🎯 Entry points to execute your program using `python -m <fast1>` or `$ fast1` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/zphiliam/fast1/branch/main/graph/badge.svg?token=fast1_token_here)](https://codecov.io/gh/zphiliam/fast1)
[![CI](https://github.com/zphiliam/fast1/actions/workflows/main.yml/badge.svg)](https://github.com/zphiliam/fast1/actions/workflows/main.yml)

Awesome fast1 created by zphiliam

## Install

from source
```bash
git clone https://github.com/zphiliam/fast1 fast1
cd fast1
make install
```
...
```bash
❯ fast1 --help
Usage: fast1 [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ fast1 create-user --help
Usage: fast1 create-user [OPTIONS] USERNAME PASSWORD
...
```bash
fast1 create-user admin admin --superuser
```
...
Run with `fast1 run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `fast1 create-user`.
...
-----------------------------------------------------
fast1/__init__.py              4      0   100%
fast1/app.py                  16      1    94%
fast1/cli.py                  21      0   100%
fast1/config.py                5      0   100%
fast1/db.py                   10      0   100%
fast1/models/__init__.py       0      0   100%
fast1/models/content.py       47      1    98%
fast1/routes/__init__.py      11      0   100%
fast1/routes/content.py       52     25    52%
fast1/routes/security.py      15      1    93%
fast1/routes/user.py          52     26    50%
fast1/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in fast1/default.toml.
